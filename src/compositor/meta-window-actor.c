...
check_needs_reshape (MetaWindowActor *self)
{
   ...
   *
   * Our "bounding region" is called the "bounding rectangle", which defines
   * the shape of the window as if the window was unshaped.
   *
   ...
   * clipped befor rendering. The region we get back hasn't been clipped.
