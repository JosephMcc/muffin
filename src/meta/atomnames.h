 ...
 *
 * This is a list of the names of all the X atoms that Muffin uses.
...
item(WM_ICON_SIZE)
item(_KWM_WIN_ICON)
item(_MUFFIN_RELOAD_THEME_MESSAGE)
item(_MUFFIN_SET_KEYBINDINGS_MESSAGE)
item(_MUFFIN_TOGGLE_VERBOSE)
item(_MUFFIN_HINTS)
