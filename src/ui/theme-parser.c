 ...
 *
 *  satisfied:        whether this version of Muffin meets the version check
                 ...
                 GError    **err)
{
  ...
  if (strcmp(theme_name, "Default") == 0)
    {
      theme_dir = g_build_filename (MUFFIN_DATADIR,
                                    "muffin",
                                    "theme",
                                    NULL);
  ...
  for (major_version = THEME_MAJOR_VERSION; (major_version > 0); major_version--)
    {
      /* We try first XDG_USER_DATA_DIR, XDG_DATA_DIRS, then system dir for themes */

      /* Try XDG_USER_DATA_DIR for themes */
      ...
      /* Look for themes in MUFFIN_DATADIR */
      theme_dir = g_build_filename (MUFFIN_DATADIR,
                                    "themes",
                                    theme_name,
                                    THEME_SUBDIR,
